...
import com.google.pages.Google_20_VerifyGmailSignOutPage;
import com.google.util.TestUtil;

public class Google_20_VerifyGmailSignOutTest  extends TestBase{
	...
	Google_20_VerifyGmailSignOutPage google_20_VerifyGmailSignOutPage;
	...
	public Google_20_VerifyGmailSignOutTest()
	{
		//super();
	}
	...
	{
		System.out.println(getTC("Google_20_VerifyGmailSignOutTest"));
		boolean j = false;
		if(getTC("Google_20_VerifyGmailSignOutTest")==j)
		{
	...
	{
		Thread.sleep(3000);
		google_20_VerifyGmailSignOutPage = google_04_GmailSignInPage.createAccount13(emailid, password);
		
		Thread.sleep(3000);
		google_20_VerifyGmailSignOutPage.clickOnSBtn();
	
		Thread.sleep(3000);
		google_20_VerifyGmailSignOutPage.clickOnSignOutBtn();
