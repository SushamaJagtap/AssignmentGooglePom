...
import com.google.pages.Google_18_VerifyGmailNewLabelPage;
import com.google.util.TestUtil;

public class Google_18_VerifyGmailNewLabelTest extends TestBase {
	...
	Google_18_VerifyGmailNewLabelPage google_18_VerifyGmailNewLabelPage;
	...
	public Google_18_VerifyGmailNewLabelTest()
	{
		//super();
	}
	...
	{
		System.out.println(getTC("Google_18_VerifyGmailNewLabelTest"));
		boolean j = false;
		if(getTC("Google_18_VerifyGmailNewLabelTest")==j)
		{
	...
	{
		Thread.sleep(3000);
		google_18_VerifyGmailNewLabelPage = google_04_GmailSignInPage.createAccount11(emailid, password);
	
		Thread.sleep(3000);
		google_18_VerifyGmailNewLabelPage.clickOncreateNewLabel();
		
		Thread.sleep(3000);
		google_18_VerifyGmailNewLabelPage.enterNewLabelTxt("jalaj");
