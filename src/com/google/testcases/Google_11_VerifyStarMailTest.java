...
public class Google_11_VerifyStarMailTest extends TestBase {
	...
	Google_11_VerifyStarMailPage google_11_VerifyStarMailPage;
	...
	public Google_11_VerifyStarMailTest()
	{
		//super();
	}
	...
	{
		System.out.println(getTC("Google_11_VerifyStarMailTest"));
		boolean j = false;
		if(getTC("Google_11_VerifyStarMailTest")==j)
		{
	...
	public void starredemails(String emailid,String password) throws InterruptedException
	{
		Thread.sleep(3000);
		google_11_VerifyStarMailPage = google_04_GmailSignInPage.createAccount2(emailid, password);
		Thread.sleep(7000);
		
		google_11_VerifyStarMailPage.clickOnStarred(); 
		
		Thread.sleep(5000);
		
		System.out.println(google_11_VerifyStarMailPage.getstarredNo());
	}
